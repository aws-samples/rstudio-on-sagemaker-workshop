...
where can put code repostiories, datasets, and other file objects. You can 
...
can utilizse internal repostiories as well.

## Publishing to RStudio Connect
Functionality to publishing to RStudio Connect works as expected and depending 
on your networking configuration for your domain can utilize RStudio connect 
servers in your private subnet.
